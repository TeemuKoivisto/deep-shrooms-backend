...
# Resizes images to 256x256 of target folder to a new folder inside folder "lp_mushroom_img"
...
magick mogrify -resize 256x256 -gravity center -extent 256x256 ./$OUTPUT_DIR/lp_mushroom_img/*.jpg